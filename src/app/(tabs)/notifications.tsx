...
function EmptyState({ filter, colors }: { filter: StatusFilter; colors: AppColors }) {
  const s = makeStyles(colors);
  return (
    <View style={s.empty}>
      ...
      <Text style={s.emptyTitle}>{filter === 'all' ? 'No orders yet' : `No ${filter} orders`}</Text>
      <Text style={s.emptySub}>
        {filter === 'all' ? 'Start planning your event and your orders will appear here.' : 'Try a different filter above.'}
      </Text>
      {filter === 'all' && (
